  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-payment-payment-module"], {
    ...
    function srcAppPagesPaymentCashpayCashpayPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var CashPayPage = /*#__PURE__*/function () {
        function CashPayPage(fb, http, loadingController, router, route, paymentservice) {
          var _this4 = this;
          ...
          this.route.queryParams.subscribe(function (params) {
            if (_this4.router.getCurrentNavigation().extras.state) {
              _this4["new"] = _this4.router.getCurrentNavigation().extras.state.user6;
              _this4.new10 = _this4.router.getCurrentNavigation().extras.state.user10;
              console.log(_this4.new10);

              for (var i = 0; i < _this4.new10.length; i++) {
                _this4.branch_new = _this4.new10[i].BranchID;
                _this4.head = _this4.new10[i].headID;
                console.log(_this4.new10[i].BranchID);

                _this4.branch1.push(_this4.branch_new);

                console.log(_this4.branch1);
                _this4.sampletest1 = [{
                  BranchID: _this4.new10[i].BranchID,
                  HeadID: _this4.new10[i].headID
                }];

                _this4.sampledata.push(_this4.sampletest1);

                _this4.sampledata1 = [].concat.apply([], _this4.sampledata);
              }

              _this4.new_array = _this4["new"];
              console.log(_this4.new_array);
            }
          });
        }
        ...
        _createClass(CashPayPage, [{
          ...
          value: function buildForm1() {
            ...
            Object.keys(this.result).forEach(function (i) {
              controlArray.push(_this6.fb.group({
                branchname: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](_this6.result[i].branchname, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
                groupno: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](_this6.result[i].groupno, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
                totalchit: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](_this6.result[i].totalchit, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
                branchid: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](_this6.result[i].branchid, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
                memberid: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](_this6.result[i].memberid, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
                m_id: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](_this6.result[i].m_id, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
                rootid: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](_this6.result[i].rootid, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
                headid: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](_this6.result[i].headid, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
                chitgroupid: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](_this6.result[i].chitgroupid, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
                agreement: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](_this6.result[i].agreement, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
                installment: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](_this6.result[i].installment, _angular_forms__WEBPACK_IMPORTED_MODULE_3__["Validators"].required),
                amountreceived: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](Number(_this6.new_array[i].amountreceived)),
                prizedarrear: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](Number(_this6.new_array[i].prizedarrear)),
                nonprizedarrear: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](Number(_this6.new_array[i].nonprizedarrear)),
                interest: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](Number(_this6.result[i].interest)),
                otheramount: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](Number(_this6.result[i].otheramount)),
                narration: new _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormControl"](_this6.result[i].narration)
              }));
            });
            console.log(controlArray);
          }
          ...
          value: function submitcash(s) {
            ...
            this.paymentservice.cash_details(this.sampledata1).subscribe(function (res) {
              console.log(res);
              _this7.receipt_res = res;

              if (_this7.receipt_res != null) {
                for (var i = 0; i < _this7.receipt_res.length; i++) {
                  console.log(_this7.receipt_res[i].AlreadyusedNo);
                  _this7.num = _this7.receipt_res[i].AlreadyusedNo + 1;
                  _this7.vnum = _this7.receipt_res[i].BranchName + '' + _this7.num;

                  _this7.num1.push(_this7.num);

                  console.log(_this7.num1);

                  _this7.vnum1.push(_this7.vnum);

                  console.log(_this7.vnum1);
                  _this7.ReceiptTable = {
                    "AlreadyusedNo": _this7.num,
                    "BranchID": _this7.receipt_res[i].BranchID,
                    "HeadID": _this7.receipt_res[i].HeadID,
                    "BranchName": _this7.receipt_res[i].BranchName,
                    "From": _this7.receipt_res[i].From,
                    "ID": _this7.receipt_res[i].ID,
                    "Isfinished": _this7.receipt_res[i].Isfinished,
                    "To": _this7.receipt_res[i].To,
                    "VoucherCode": _this7.receipt_res[i].VoucherCode,
                    "VoucherNumber": _this7.vnum
                  };
                  console.log(_this7.ReceiptTable);

                  _this7.ReceiptTable1.push(_this7.ReceiptTable);

                  console.log(_this7.ReceiptTable1);
                }

                _this7.paymentservice.receipt_update(_this7.ReceiptTable1).subscribe(function (res) {
                  console.log(res);
                  _this7.res_status = res;
                  console.log(_this7.res_status);

                  if (_this7.res_status == 0) {
                    var _iterator = _createForOfIteratorHelper(_this7.sampletest),
                        _step;
                    ...
                    for (var _i = 0; _i < _this7.sampletest.length; _i++) {
                      console.log(_this7.sampletest[_i].branchname, "naming");

                      var strFirstThree = _this7.sampletest[_i].branchname.substring(0, 3).toUpperCase();

                      ;
                      console.log(strFirstThree);
                      _this7.new_name = strFirstThree;
                      _this7.voucher_count = _this7.voucher_count + 1;
                      console.log(_this7.trigger, "trigg");
                      _this7.receipt_name = _this7.new_name + localStorage.getItem('col_id') + _this7.voucher_count;
                      console.log(_this7.receipt_name, "rec");

                      if (_this7.sampletest[_i].prizedarrear != 0) {
                        _this7.cashpdata = [{
                          "Amount": +_this7.sampletest[_i].amountreceived + +_this7.sampletest[_i].prizedarrear,
                          "PArrear": _this7.sampletest[_i].prizedarrear,
                          "IsDeleted": 0,
                          "MemberID": _this7.sampletest[_i].memberid,
                          "ReceievedBy": "admin",
                          "Series": "BCAPP",
                          "T_Day": _this7.day,
                          "T_Month": _this7.month,
                          "T_Year": _this7.year,
                          "Trans_Medium": "0",
                          "Trans_Type": "1",
                          "TransactionKey": 0,
                          "Voucher_No": _this7.count = _this7.count + 1,
                          "Voucher_Type": "C",
                          "IsAccepted": "0",
                          "AppReceiptno": _this7.receipt_name,
                          "ISActive": true,
                          "BranchID": _this7.sampletest[_i].branchid,
                          "ChitGroupId": _this7.sampletest[_i].chitgroupid,
                          "Narration": _this7.sampletest[_i].narration,
                          "Head_Id": _this7.sampletest[_i].headid,
                          "Other_Trans_Type": 1,
                          "RootID": _this7.sampletest[_i].rootid,
                          "M_Id": _this7.sampletest[_i].m_id,
                          "Type": "Cash",
                          "MoneyCollId": _this7.post_id,
                          "VoucherCount": _this7.voucher_count
                        }, {
                          "Amount": +_this7.sampletest[_i].amountreceived + +_this7.sampletest[_i].prizedarrear,
                          "PArrear": _this7.sampletest[_i].prizedarrear,
                          "IsDeleted": 0,
                          ...
                          "Amount": +_this7.sampletest[_i].interest + +_this7.sampletest[_i].otheramount,
                          "Interest": _this7.sampletest[_i].interest,
                          "OtherAmt": _this7.sampletest[_i].otheramount,
                          "IsDeleted": 0,
                          "MemberID": _this7.sampletest[_i].memberid,
                          "ReceievedBy": "admin",
                          "Series": "BCAPP",
                      ...
                      } else if (_this7.sampletest[_i].nonprizedarrear != 0) {
                        _this7.cashpdata = [{
                          "Amount": +_this7.sampletest[_i].amountreceived + +_this7.sampletest[_i].nonprizedarrear,
                          "NPArrear": _this7.sampletest[_i].nonprizedarrear,
                          "IsDeleted": 0,
                          "MemberID": _this7.sampletest[_i].memberid,
                          "ReceievedBy": "admin",
                          "Series": "BCAPP",
                      ...
                      _this7.cashdata.push(_this7.cashpdata);

                      _this7.cashdata1 = [].concat.apply([], _this7.cashdata);

                      for (var _i2 = _this7.cashdata1.length - 1; _i2 >= 0; --_i2) {
                        if (_this7.cashdata1[_i2].Amount == "0") {
                          _this7.cashdata1.splice(_i2, 1);

                          console.log(_this7.cashdata1);
                        }
                      }
                    }

                    _this7.paymentservice.post_vouchercash(_this7.cashdata1).subscribe(function (res) {
                      console.log(res);
                      _this7.voucher_res = res;

                      if (res) {
                        _this7.dismiss();

                        _this7.second_voucher = res;
                        alert('sucessfully updated');
                        localStorage.setItem("print_cash", JSON.stringify(_this7.voucher_res));

                        _this7.router.navigateByUrl('cashprint');
                      } else {
                        alert('voucher error');
    ...
    function srcAppPagesPaymentPaymentPageScss(module, __webpack_exports__, __webpack_require__) {
      ...
      __webpack_exports__["default"] = ".flex_arrow {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n}\n\n.logout {\n  padding-top: 2rem;\n  padding-right: 2rem;\n  color: #fff;\n}\n\n.arrow {\n  margin-top: 1rem;\n  margin-left: 2rem;\n  background: linear-gradient(to right, #222428 0%, #354466 100%) !important;\n  border-radius: 50%;\n  color: #fff;\n  font-size: 30px;\n}\n\n.payment {\n  --background: linear-gradient(to right, #222428 0%, #354466 100%) !important;\n}\n\n.payee_name {\n  color: #fff;\n  font-weight: bold;\n  margin-left: 12px;\n}\n\n.today_date {\n  color: #fff;\n  margin-left: 12px;\n}\n\n.flex-page {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n}\n\n.flex-page .payee_no {\n  margin-left: 12px;\n}\n\n.flex-page .data-no {\n  margin-right: 1rem;\n  color: #5E5CA5;\n  font-weight: bold;\n}\n\n.left {\n  border-right: 1px #F05940 solid;\n}\n\n.title span {\n  font-size: 12px;\n  font-weight: 600;\n}\n\n.title .pipe {\n  margin-left: 12px;\n}\n\nion-card {\n  background-color: #F6F6FA;\n}\n\n.value {\n  color: #272727;\n}\n\nion-checkbox {\n  float: right;\n}\n\nion-card-content p span {\n  margin-left: 15px;\n}\n\n.mode {\n  margin-left: 12px;\n}\n\n.text {\n  display: inline-block;\n  vertical-align: middle;\n  padding-left: 10px;\n}\n\n.icon {\n  display: inline-block;\n  font-size: 22px;\n  color: #6765AA;\n  vertical-align: middle;\n}\n\n.cash-content p {\n  padding-left: 15px;\n}\n\n.cash-content .mat-form-field {\n  display: block;\n  font-size: 14px;\n  margin: 5px 15px;\n}\n\n.flex {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n}\n\n.logout {\n  padding-top: 2rem;\n  padding-right: 2rem;\n  color: #fff;\n}\n\n.cash {\n  --background: linear-gradient(to right, #222428 0%, #354466 100%) !important;\n}\n\n.exit {\n  color: #fff;\n  display: inline-block;\n  font-size: 22px;\n  vertical-align: middle;\n}\n\n.arrow {\n  margin-top: 1rem;\n  margin-left: 2rem;\n  background: #37348B;\n  border-radius: 50%;\n  color: #fff;\n  font-size: 30px;\n}\n\n.today_date {\n  color: #fff;\n  margin-left: 12px;\n}\n\n.total-chit {\n  padding-right: 12px;\n}\n\n.align {\n  display: flex;\n  justify-content: space-between;\n}\n\n.next {\n  margin-left: 15px;\n  width: 92%;\n  margin-top: 2rem;\n  height: 40px;\n  border-radius: 40px;\n  background: #413E95;\n  color: white;\n  font-weight: bold;\n  font-size: 16px;\n  cursor: pointer;\n}\n\n.total-chit {\n  padding-right: 12px;\n}\n\n.align {\n  display: flex;\n  justify-content: space-between;\n}\n\n.align p {\n  margin-left: -42px;\n}\n\n.flex {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-between;\n}\n\n.logout {\n  padding-top: 2rem;\n  padding-right: 2rem;\n  color: #fff;\n}\n\n.arrow {\n  margin-top: 1rem;\n  margin-left: 2rem;\n  background: #37348B;\n  border-radius: 50%;\n  color: #fff;\n  font-size: 30px;\n}\n\n.today_date {\n  color: #fff;\n  margin-left: 12px;\n}\n\n.cash {\n  --background: linear-gradient(to right, #222428 0%, #354466 100%) !important;\n}\n\n.bottom_icon {\n  position: fixed;\n  left: 85%;\n  bottom: 2px;\n  border-radius: 50%;\n  font-size: 28px;\n  background: #37348B;\n  padding: 5px;\n  color: white;\n}\n\n.text1 {\n  display: inline-block;\n  vertical-align: middle;\n  padding-left: 10px;\n  color: white;\n}\n\n.icon_tool {\n  padding-top: 1rem;\n  padding-right: 1rem;\n}\n\n.payeename {\n  margin-top: 1rem;\n}\n\n.bank {\n  padding-left: 8px;\n  font-weight: bold;\n}\n\n.amt {\n  font-weight: bold;\n  color: black;\n}\n\nion-spinner {\n  stroke: #ff0000;\n  fill: #8b0000;\n  position: fixed;\n  z-index: 999;\n  height: 5em;\n  overflow: show;\n  margin: auto;\n  top: 0;\n  left: 0;\n  bottom: 0;\n  right: 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
      /***/
    },
    ...
    function srcAppPagesPaymentPaymentPageTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var PaymentPage = /*#__PURE__*/function () {
        function PaymentPage(route, router, paymentservice) {
        ...
        _createClass(PaymentPage, [{
          ...
          value: function ionViewWillEnter() {
            ...
            this.paymentservice.payment_details(this.user_details.MemberID).subscribe(function (res) {
              console.log(res);
              _this9.payee_details = res;

              for (var i = 0; i < _this9.payee_details.length; i++) {
                console.log(_this9.payee_details[i].status);
                _this9.status = _this9.payee_details[i].status;
                _this9.arrear = _this9.payee_details[i].arrearamount;
                _this9.prized = _this9.payee_details[i].isprized;

                if (_this9.status == 'R' || _this9.arrear > 0) {
                  _this9.pushvalue.push(_this9.payee_details[i]);

                  var dups = [];
                  _this9.newarr = _this9.pushvalue.filter(function (el) {
                  ...
                  _this9.length1 = _this9.pushvalue.length;
                }

                if (_this9.payee_details[i].isprized == 'N') {
                  // this.checkbox=false;
                  _this9.payee_details[i].isprized = 'Non-Prized';
                } else {
                  // this.checkbox=true;
                  _this9.payee_details[i].isprized = 'Prized';
                }
              }
            });
          }

...
const routes = [
    ...
    { path: 'payment', loadChildren: () => Promise.all(/*! import() | pages-payment-payment-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-payment-payment-module")]).then(__webpack_require__.bind(null, /*! ./pages/payment/payment.module */ "./src/app/pages/payment/payment.module.ts")).then(m => m.PaymentPageModule) },
    { path: 'cashprint', loadChildren: () => Promise.all(/*! import() | pages-cashprint-cashprint-module */[__webpack_require__.e("common"), __webpack_require__.e("pages-cashprint-cashprint-module")]).then(__webpack_require__.bind(null, /*! ./pages/cashprint/cashprint.module */ "./src/app/pages/cashprint/cashprint.module.ts")).then(m => m.CashprintPageModule) },
];
...
module.exports = __webpack_require__(/*! /home/altius/gopika/SVCFBILLCOLLECTORAPP/src/main.ts */"./src/main.ts");
